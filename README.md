...
또한 구역별 분류 및 배송 상태 관리 기능을 통해 실제 물류 시스템 흐름을 반영하도록 구성했으며,
바코드 기반 조회·등록 기능과 물류 현황 통계 기능을 구현했습니다.

---

## 📅 프로젝트 정보
- 개발 기간: 2026.05.06 ~ 2026.05.21
- 개발 형태: 개인 프로젝트
- 개발 언어: Kotlin
...
### 🔄 배송 상태 자동 갱신 문제
- 시간 경과에 따라 배송 상태가 변경되어야 했지만 화면에 즉시 반영되지 않는 문제가 발생
- 상태 갱신 로직과 목록 새로고침 구조를 개선하여 자동 반영 처리
...
## 🚀 프로젝트 특징
- 바코드 생성 및 스캔 기능을 활용한 택배 관리 시스템 구현
- SQLite 기반 로컬 데이터 저장 및 조회 기능 구현
- 배송 상태 및 구역 분류 기반 물류 관리 기능 구현
...
- 상태별 및 구역별 택배 현황 관리 기능 구현
- 실시간 데이터 기반 통계 확인 기능 구현
- 바코드 스캔 기반 조회 및 신규 등록 기능 구현
- 배송 상태 자동 변경 기능을 통한 물류 흐름 관리 구현
